                    ...
                    <div className="col-lg-12">
                        <div className="position-relative newsletter-inner">
                            <div className="newsletter-content">
                                ...
                                <p className="mb-45">Start You Daily Shopping with <span className="text-brand">Nest Mart</span></p>
                ...
                <div className="row">
                    <div className="col">
                        <div className="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            <div className="logo mb-30">
                                <a href="index.html" className="mb-15"><img src="./imgs/theme/logo.svg" alt="logo" /></a>
                            ...
                            <ul className="contact-infor">
                                ...
                                <li><img src="./imgs/theme/icons/icon-email-2.svg" alt="" /><strong>Email:</strong><span><a href="http://wp.alithemes.com/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="dcafbdb0b99c92b9afa8f2bfb3b1">voduchuy2001@gmail.com</a></span></li>
                    ...
                    <div className="footer-link-widget widget-install-app col wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                        ...
                        <div className="download-app">
                            <a href="#" className="hover-up mb-sm-2 mb-lg-0"><img className="active" src="./imgs/theme/app-store.jpg" alt="" /></a>
                            <a href="#" className="hover-up mb-sm-2"><img src="./imgs/theme/google-play.jpg" alt="" /></a>
                        </div>
